...
export async function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-3 px-4 md:px-6 h-[calc(4rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] border-b border-border/40 glass-strong">
