        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4 py-6">
          ...
          >
            ...
            <div className="px-5 pb-5 space-y-4">
              ...
              >
                {busy === "json"
                  ? <Loader2 className="w-5 h-5 text-accent-strong animate-spin shrink-0" />
                  : <FileJson className="w-5 h-5 text-accent-strong shrink-0" />}
                <div>
              ...
              {/* Per-table CSV */}
              <div>
                <p className="text-[10px] font-semibold deck-label text-muted-foreground/60 mb-2">
