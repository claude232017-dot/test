  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="flex items-center gap-2 rounded-full p-0.5 pr-1 transition-colors hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/50 cursor-pointer"
      >
