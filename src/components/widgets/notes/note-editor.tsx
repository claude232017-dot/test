  ...
  return (
    <div className="flex flex-col h-full gap-0 px-4">
      ...
      <textarea
        ...
        className="flex-1 bg-transparent resize-none text-base sm:text-sm leading-relaxed p-3 min-h-0 text-foreground placeholder:text-muted-foreground/30 rounded-xl border border-[rgba(var(--overlay),0.06)] focus:border-purple-500/40 transition-colors"
