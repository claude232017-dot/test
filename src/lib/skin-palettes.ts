 ...
 */
const PALETTES = {
  prism: ["#f5c542", "#0f9bbd", "#9085e9", "#0ca30c", "#e66767", "#c98500", "#37d67a", "#b9b8ae"],
 ...
 */
const ACCENTS = {
  prism:   { primary: "#f5c542", success: "#0ca30c", accent: "#0f9bbd", progress: "linear-gradient(90deg, #f5c542, #0f9bbd)" },
